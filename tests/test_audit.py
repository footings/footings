...
def test_audit_xlsx(tmp_path):
    ...
    assert compare_xlsx_files(test_integer_out, expected_integer_out, EXCLUDE_FILES, {})
    ...
    assert compare_xlsx_files(test_pandas_out, expected_pandas_out, EXCLUDE_FILES, {})
